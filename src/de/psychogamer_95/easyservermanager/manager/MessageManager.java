...
public class MessageManager {
    ...
    public static void  loadFile(){
        ...
        setValue("Message.Use_Kick", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Check", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_GameMode", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Ban", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Gamemode", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Mute", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Tempban", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_TimeManager", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Unban", "&bUse: &7/kick <Player> <Reason>");
        setValue("Message.Use_Weather", "&bUse: &7/weather <Sonne> or <Regen>");
        ...
        setValue("Message.SetSun", "&bWeather set to Sun!");
        setValue("Message.SetRain", "&bWeather set to Rain!");
