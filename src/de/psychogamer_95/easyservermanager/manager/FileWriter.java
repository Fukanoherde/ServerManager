...
public class FileWriter {
    ...
    public de.psychogamer_95.easyservermanager.manager.FileWriter setValue(String ValuePath, Object Value) {
        this.c.set(ValuePath, Value);
        return this;
    }
    public de.psychogamer_95.easyservermanager.manager.FileWriter setDefaultValue(String ValuePath, Object Value) {
    ...
    public de.psychogamer_95.easyservermanager.manager.FileWriter save() {
        try {
            this.c.save(this.f);
